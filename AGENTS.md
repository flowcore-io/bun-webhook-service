...
- Provide workspace scope and begin with `repo:bun-webhook-service` tags; iterate until the tool reports `decision: "SUFFICIENT"`.
...
Repository: bun-webhook-service
WorkspaceId: 60c10ca2-4115-4c1a-b6d7-04ac39fd3938
Workspace: Flowcore
Workspace Fragment Types: knowledge, recipe, solution, template, architectural decision, commands, feature request, infrastructure, instruction set, issue, llm persona, llm rules, outage investigation, plan, prd, prompt, research, ticket, violation exception
